...
class RoleController extends Controller {
  ...
  async show() {
    const { ctx, service } = this;
    ctx.validate(ctx.rules.roleId, ctx.query);
  ...
  async create() {
    const ctx = this.ctx;
    ctx.validate(ctx.rules.roleBodyReq, ctx.request.body);
  ...
  async update() {
    const { ctx, service } = this;
    ctx.validate(ctx.rules.rolePutBodyReq, ctx.request.body);
  ...
  async destroy() {
    const { ctx, service } = this;
    ctx.validate(ctx.rules.roleDelBodyReq, ctx.request.body);
  ...
  async updateIsDefault() {
    const { ctx, service } = this;
    ctx.validate(ctx.rules.roleId, ctx.request.body);
